...
//getUserSchemas($schemas, $autenticator);
//exit();
...
function getUserSchemas($schemas) {
	...
	$data = $schemas->getSchemas($_SESSION["login"]);
	$return["json"] = $data;
